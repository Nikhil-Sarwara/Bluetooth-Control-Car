...
#define MOTOR_1A 4   // Connect motor driver input 1 to pin 11
#define MOTOR_1B 5   // Connect motor driver input 2 to pin 10
#define MOTOR_2A 6     // Connect motor driver input 3 to pin 9
#define MOTOR_2B 7     // Connect motor driver input 4 to pin 6
...
void loop() {
  ...
  {
    analogWrite(3, readString.toInt());
